  ...
  return (
    ...
    <h4 className='text-center mb-2 text-lg font-Ovo'>Projects</h4>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
       ...
       <div className='grid grid-cols-auto my-10 gap-5'>{workData.map((project,index)=>(
        <div className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative
        cursor-pointer group' key={index} style={{backgroundImage:`url(${project.bgImage})`}}>
            <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 
            -translate-x-1/2 py-3 py-5 flex items-center
